...
import com.MeiTuan.pojo.TEvaluate;
import com.MeiTuan.pojo.TEvaluateExample;

public interface TEvaluateMapper {
    int countByExample(TEvaluateExample example);
    ...
    List<TEvaluate> selectByExampleWithBLOBs(TEvaluateExample example);

    List<TEvaluate> selectByExample(TEvaluateExample example);

    TEvaluate selectByPrimaryKey(Integer evaluateId);

    int updateByExampleSelective(@Param("record") TEvaluate record, @Param("example") TEvaluateExample example);

    int updateByExampleWithBLOBs(@Param("record") TEvaluate record, @Param("example") TEvaluateExample example);
    ...
    int updateByPrimaryKeyWithBLOBs(TEvaluate record);
