        ...
        <ul class="nav nav-pills">
                <li class="info-a">
                    <a href="${pageContext.request.contextPath}/information" style="color: #F22E00">
                        <%-- ${sessionScope.loginUser.telephone} --%>123456
    ...
    <nav class="navbar navbar-default" id="header-nav-middle">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="${pageContext.request.contextPath}/main"><!-- <img alt="Brand" style="display: inline-block;" src="./image/tao.jpg" width="20" height="20"> --><span class="logo-word">美团</span></a>
            </div>
            ...
            <div class="collapse navbar-collapse"
                ...
                <ul class="nav navbar-nav">
                    <li><a class="a-color" href="${pageContext.request.contextPath}/restaurant/restaurantPage">首页</a></li>
