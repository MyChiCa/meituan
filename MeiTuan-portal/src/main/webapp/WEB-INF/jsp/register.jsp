...
<body>
	...
	<div id="register_content">
		<form action="${pageContext.request.contextPath }/insert.action" method="post" onsubmit="return checkNull();">
		<center>
		<fieldset>
			<legend>用户注册</legend>
			<div>
			...
			<div style="margin-top:10px;"><a href="${pageContext.request.contextPath }/login" id="got">已注册，返回登录</a></div>
		</fieldset>
		</center>
		</form>
	</div>
